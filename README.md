...
Specs live in the umbrella repo: [`../specs/agent-specs/`](../specs/agent-specs/). Product refactor progress: [`../specs/product-backlog.md`](../specs/product-backlog.md). True-agent redesign: [`../specs/agent-specs/real-agent-refactory.md`](../specs/agent-specs/real-agent-refactory.md). MVP-6 design source: Claude Code Plan `~/.claude/plans/flickering-humming-gizmo.md`.
...
| [`../specs/product-backlog.md`](../specs/product-backlog.md) | Batch status (MVP-1…MVP-7 ✅; MVP-8 F34–38 ✅ ADR-040/043 D9) |
